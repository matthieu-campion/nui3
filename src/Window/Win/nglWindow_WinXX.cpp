...
#define OUT_FB_ERROR(X) case X: NGL_OUT(_T("FrameBuffer Error: %ls\n"), _T(#X)); NGL_ASSERT(0);  break;
...
{                                                               \
  ...
  OUT_FB_ERROR(GL_FRAMEBUFFER_INCOMPLETE_DUPLICATE_ATTACHMENT_EXT)       \
  ...
  case WM_IME_SETCONTEXT:
    {
      ...
      Form.ptCurrentPos.x = 150;
      Form.ptCurrentPos.y = 150;
...
//           pForm->ptCurrentPos.x = 150;
//           pForm->ptCurrentPos.y = 150;
//           return TRUE;
//         }
//         break;
//       }
