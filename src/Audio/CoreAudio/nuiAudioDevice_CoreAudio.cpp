...
public:
  ...
  {
    // nothing to do here...
    printf("Registered nuiAudioDeviceAPI_CoreAudio API with nuiAudioDeviceManager\n");
  }
...
static nuiAudioDeviceAPI_CoreAudio CoreAudioAPI;

nuiAudioDeviceAPI* GetCoreAudioAPI()
{
  return &CoreAudioAPI;
}
