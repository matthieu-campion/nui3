...
enum nuiFontStraight
{
  ...
  eStraight_ArmsWedge,
  eStraight_ArmsVert,
  eStraight_ArmsSingleSerif,
  eStraight_ArmsDoubleSerif,
  eBent_ArmsHorz,
  eBent_ArmsWedge,
  eBent_ArmsVert,
  eBent_ArmsSingleSerif,
  eBent_ArmsDoubleSerif
};
...
enum nuiFontLett
{
  ...
  eLett_NoFit,
  eLett_NormalCompact,
  eLett_NormalWeighted,
  eLett_NormalBoxed,
  eLett_NormalFlattened,
  eLett_NormalRounded,
  eLett_NormalOffCenter,
  eLett_NormalSquare,
  eLett_ObliqueCompact,
  eLett_ObliqueWeighted,
  eLett_ObliqueBoxed,
  eLett_ObliqueFlattened,
  eLett_ObliqueRounded,
  eLett_ObliqueOffCenter,
  eLett_ObliqueSquare
};
