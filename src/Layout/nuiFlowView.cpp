...
void nuiFlowView::LayoutLine(std::vector<nuiWidgetPtr>& line, float& x, float &y, float& w, float& h, float& HSpace, float &VSpace, bool setLayout)
{
  // Process the line
  if (setLayout)
  {
