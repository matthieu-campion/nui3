...
#define APPLICATION_TITLE _T("sqlite-Editor")


NGL_APP_CREATE(Application);

Application::Application()
: mPreferences(_T("NUI/sqlitor.pref"))
{
  mpMainWindow = NULL;
}
...
void Application::SetWindowTitle(const nglString& projectName)
{
  mpMainWindow->GetNGLWindow()->SetTitle(projectName);
...
PreferencesBase& Application::GetPreferences()
{
  return mPreferences;
}
...
{
  return ((Application*)App)->GetPreferences();
}
