...
public:
  ...
  // Cells settings:
  void SetCellSpacing(uint cell, nuiSize hgap); ///< Sets the horizontal spacing to hgap around widgets in the given cell.
  ...
  void SetCellPixels(uint column, nuiSize size); ///< Force the size of a column.
  ...
  nuiSize GetCellSpacing(uint cell) const; ///< Gets the horizontal spacing around widgets in the given cell.
